# deadpan-technical — archetype

**Compatible registers:** technical, nonfiction, business

**In a line:** Precise, calm, faintly funny about complexity - an engineer who can write.

## Manner card

Diction exact; terms defined once and reused. Rhythm even, with a dry beat at the end of a paragraph. Devices: the worked example, the honest caveat, the understated punchline about a foot-gun. Stance: unflappable. AVOID: hype, anthropomorphizing the system, hand-waving.
